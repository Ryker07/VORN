...
const GUIDE_DATA = {
        ...
        sections: [
            {
                ...
                content: [
                    ...
                    '┃ `/antinuke whitelist [user]` — Exempt a user',
    ...
    welcome: {
        ...
        description: 'Canvas Cards · Goodbye · Auto-Role',
        sections: [
            {
                name: 'Setup',
                content: [
                    '### Welcome Setup',
                    '',
                    '> Canvas-powered welcome cards with 10+ premium templates',
                    '',
                    '**Quick Start**',
                    '┃ `/welcome enable [channel]`',
                    '┃ `/welcome disable`',
                    '┃ `/welcome test` — Preview your config',
                    '',
                    '**Templates**',
                    '```',
                    'obsidian  · snow    · aurora',
                    'ocean     · sunset  · midnight',
                    'rose      · neon    · discord',
                    '```',
                    '┃ `/welcome template [name]`',
                    '',
                    '-# Each template has unique colors, style, and layout'
                ]
            },
            {
                name: 'Customization',
                content: [
                    ...
                    '',
                    '**Canvas Options**',
                    '┃ `/welcome background [url]` — Custom image',
                    '┃ `/welcome color [hex]` — Accent color',
                    '┃ `/welcome avatar [circle/square/rounded/hexagon]`',
                    '',
                    '**Placeholders**',
                    '╸ `{user}` — @mention',
                    '╸ `{username}` — Name',
                    ...
                    '╸ `{count}` — Member count',
                    '',
                    '-# Combine canvas + embed for the richest welcome experience'
                ]
            },
            {
                name: 'Goodbye & DM',
                content: [
                    ...
                    '',
                    '┃ `/welcome dm enable`',
                    '┃ `/welcome dm message [text]`',
                    '┃ `/welcome dm disable`',
                    '',
                    '### Auto-Role',
                    '',
                    '┃ `/welcome autorole [role]` — Auto-assign on join',
                    '┃ `/welcome autorole remove`',
                    '',
                    '-# DM messages may fail if user has DMs disabled'
                ]
            }
        ]
    },
